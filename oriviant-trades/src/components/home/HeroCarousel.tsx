...
const SLIDES: SlideData[] = [
  {
    ...
    badgeIcon: Sparkles,
    heading: 'Trade Crypto Like a Professional',
    description: 'Access Spot, Futures, Stocks, Forex, Commodities and Copy Trading from one secure platform.',
    primaryBtnText: 'Start Trading',
    primaryBtnTab: 'spot',
    secondaryBtnText: 'Explore Futures 125x',
    secondaryBtnTab: 'futures',
  ...
  {
    id: 'slide-2',
    badge: 'RISK-FREE DEMO ACCOUNT',
    badgeIcon: Zap,
    heading: 'Practice Before You Trade',
    description: 'Open a Demo Practice account with $10,000 virtual funds. Learn without risking real money.',
    primaryBtnText: 'Try Demo Practice',
    primaryBtnTab: 'demo-workspace',
    secondaryBtnText: 'Practice Desk',
    secondaryBtnTab: 'practice-mode',
  ...
  {
    id: 'slide-3',
    badge: 'AUTOMATED STRATEGIES',
    badgeIcon: Users,
    heading: 'Copy Successful Traders',
    description: 'Discover experienced traders. View real performance stats. Copy top strategies automatically.',
    primaryBtnText: 'Explore Copy Trading',
    primaryBtnTab: 'copy-trading',
  ...
  {
    id: 'slide-4',
    badge: 'MULTI-ASSET COVERAGE',
    badgeIcon: Globe,
    heading: 'Trade Global Markets',
    description: 'Crypto, Stocks, Forex, Gold, Silver, Oil, Indices, ETFs and more on unified 24/7 markets.',
    primaryBtnText: 'Explore Markets',
    primaryBtnTab: 'markets',
    secondaryBtnText: 'Spot Desk',
    secondaryBtnTab: 'spot',
    gradient: 'from-sky-950 via-blue-950 to-slate-950 border-sky-500/30',
  ...
  },
  {
    ...
    heading: 'Fast & Secure Transactions',
    description: 'Protected wallets, Multi-signature cold storage, Two-Factor Authentication & encrypted transactions.',
    primaryBtnText: 'View Security Settings',
    primaryBtnTab: 'settings',
  ...
  {
    id: 'slide-6',
    badge: 'ORIVIANT ACADEMY',
    badgeIcon: BookOpen,
    heading: 'Learn While You Trade',
    description: 'Interactive Academy with beginner lessons, intermediate strategies, technical analysis & quizzes.',
    primaryBtnText: 'Start Learning',
    primaryBtnTab: 'academy',
    gradient: 'from-indigo-950 via-purple-950 to-slate-950 border-indigo-500/30',
