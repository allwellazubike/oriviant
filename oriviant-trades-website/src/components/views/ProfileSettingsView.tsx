      ...
      <div className="p-6 rounded-3xl bg-app-card border border-app shadow-md space-y-6">
        <div>
          <h3 className="text-sm font-bold text-app flex items-center gap-2">
            ...
            <span>Trading Preferences & Theme Customization</span>
          </h3>
          <p className="text-xs text-app-sec">Customize theme mode, color palettes, candlestick chart colors, and localization</p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div>
            <label className="block text-xs font-semibold text-app-sec mb-1.5">Theme Mode</label>
            <div
              className="w-full py-2.5 px-3 rounded-xl bg-app-sub border border-app text-xs font-bold text-app flex items-center justify-between gap-2 shadow-sm opacity-90 cursor-default"
            >
          ...
          <div>
            <label className="block text-xs font-semibold text-app-sec mb-1.5">Language</label>
            <select
              value={language}
              onChange={(e) => setLanguage(e.target.value)}
              className="w-full bg-app-sub border border-app rounded-xl px-3 py-2.5 text-xs font-bold text-app focus:outline-none focus:border-accent cursor-pointer"
            >
          ...
          <div>
            <label className="block text-xs font-semibold text-app-sec mb-1.5">Display Currency</label>
            <select
              value={currency}
          ...
          <div>
            <label className="block text-xs font-semibold text-app-sec mb-1.5">Theme & Color Customizer</label>
            <button
              onClick={() => {
                const headerBtn = document.querySelector('button[title="Theme & Color Customizer"]') as HTMLButtonElement;
                if (headerBtn) headerBtn.click();
              }}
              className="w-full py-2.5 px-3 rounded-xl bg-accent text-white font-black text-xs flex items-center justify-center gap-2 cursor-pointer shadow-md hover:opacity-90 transition-opacity"
            >
